    ...
    <div id="app" v-cloak>
        <div class="register-box">
            <div class="register-logo">
                <a href="{{ url('/home') }}"><b>Sistema</b> Issue</a>
            </div>
            ...
            <div class="register-box-body">
                <p class="login-box-msg">Nevo usuario</p>
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-xs-push-1">
                            <button type="submit" class="btn btn-primary btn-block btn-flat">Terminos y condiciones</button>
                        </div><!-- /.col -->
                    </div>
                </form>
